...
{
    public partial class fSuaPhieuMuon : Form
    {
        QuanLyThuVien_CSharpDataContext db = new QuanLyThuVien_CSharpDataContext();
        int index = -1;
        int maPhieu;
        fQuanLyPhieuMuon QLPhieuMuon;

        public fSuaPhieuMuon()
        {
            InitializeComponent();
        }

        public fSuaPhieuMuon(fQuanLyPhieuMuon f, int ma)
        {
            InitializeComponent();
            QLPhieuMuon = f;
            this.maPhieu = ma;
        ...
        private void fSuaPhieuMuon_Load(object sender, EventArgs e)
        {
            loadForm();
        }
